...
include("../../../../../includes/document.parser.class.inc.php");
$modx = new DocumentParser;
require_once $_SERVER['DOCUMENT_ROOT'] . "/assets/plugins/transalias/transalias.class.php";
global $trans;
global $char_restrict;
global $word_separator;
$table_name = 'russian';
$remove_periods = 'No';
$char_restrict = 'legal characters';
$word_separator = 'dash';
...
function translit($name){	global $char_restrict;	global $word_separator;	global $trans;	return $trans->stripAlias($name, $char_restrict, $word_separator);}


function unicode2win($s){	$s = preg_replace('/\%u0([0-9a-fA-F]{3})/','&#x\1;',$s);	return html_entity_decode($s, ENT_NOQUOTES,'UTF-8');}
